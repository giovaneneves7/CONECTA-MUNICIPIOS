package br.edu.ifba.conectairece.api.features.document.domain.enums;

/**
 * Represents the lifecycle status of a {@link br.edu.ifba.conectairece.api.features.document.domain.model.Document}.
 * <p>
