...
public class JWTLoginFilter extends OncePerRequestFilter {
    ...
    private static final List<String> PUBLIC_ENDPOINTS = List.of("/api/v1/auth/users/user", "/api/v1/auth/sessions/session",
            ...
            , "/api/v1/municipal-services/**", "/api/v1/municipal-services", "/api/v1/requests/**", "/api/v1/requests", "/api/v1/requirement-types/**", "/api/v1/requirement-types", "/api/v1/construction-license-requirements");
