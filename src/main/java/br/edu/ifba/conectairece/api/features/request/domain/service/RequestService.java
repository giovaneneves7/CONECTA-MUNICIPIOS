...
public class RequestService implements RequestIService {
  ...
  private final ConstructionLicenseRequirementRepository requirementRepository;
  ...
  public Page<RequestResponseDto> findAllByStatusHistory_NewStatus(String statusHistoryNewStatus, Pageable pageable) {
    ...
    return requestsPage.map(request -> this.objectMapperUtil.mapToRecord(request, RequestResponseDto.class));
  }
