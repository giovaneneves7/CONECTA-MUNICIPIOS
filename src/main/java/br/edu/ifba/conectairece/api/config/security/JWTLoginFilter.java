...
public class JWTLoginFilter extends OncePerRequestFilter {
    ...
    private static final List<String> PUBLIC_ENDPOINTS = List.of("/api/v1/auth/users/user", "/api/v1/auth/sessions/session",
            ...
            "/api/v1/requirement-types", "/api/v1/construction-license-requirements", "/api/v1/profiles", "/api/v1/profiles/**", "/api/v1/users", "/api/v1/users/**", "/api/v1/technical-responsibles", "/api/v1/technical-responsibles/**");
